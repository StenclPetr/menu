<?php
// source: C:\xampp\htdocs\menu\app/config/config.neon 
// source: C:\xampp\htdocs\menu\app/config/config.local.neon 

class Container_85c4e39194 extends Nette\DI\Container
{
	protected $meta = [
		'types' => [
			...
			'app\Model\connDatabase' => [1 => ['1']],
			'app\Model\mailService' => [1 => ['2']],
			'Nette\Security\IAuthenticator' => [1 => ['authenticator']],
			'app\Model\autentikator' => [1 => ['authenticator']],
			...
			'App\Presenters\AddAlergenpagePresenter' => [1 => ['application.1']],
			'App\Presenters\AddJidlopagePresenter' => [1 => ['application.2']],
			'App\Presenters\AlergenypagePresenter' => [1 => ['application.3']],
			'App\Presenters\ConfirmpagePresenter' => [1 => ['application.4']],
			'App\Presenters\DetailApagePresenter' => [1 => ['application.5']],
			'App\Presenters\DetailpagePresenter' => [1 => ['application.6']],
			...
			'App\Presenters\LoginpagePresenter' => [1 => ['application.10']],
			'App\Presenters\RegistracepagePresenter' => [1 => ['application.11']],
			'NetteModule\ErrorPresenter' => [1 => ['application.12']],
			'NetteModule\MicroPresenter' => [1 => ['application.13']],
			'Nette\DI\Container' => [1 => ['container']],
		],
		'services' => [
			'application.1' => 'App\Presenters\AddAlergenpagePresenter',
			'application.10' => 'App\Presenters\LoginpagePresenter',
			'application.11' => 'App\Presenters\RegistracepagePresenter',
			'application.12' => 'NetteModule\ErrorPresenter',
			'application.13' => 'NetteModule\MicroPresenter',
			'application.2' => 'App\Presenters\AddJidlopagePresenter',
			'application.3' => 'App\Presenters\AlergenypagePresenter',
			'application.4' => 'App\Presenters\ConfirmpagePresenter',
			'application.5' => 'App\Presenters\DetailApagePresenter',
			'application.6' => 'App\Presenters\DetailpagePresenter',
	...
	public function __construct(array $params = [])
	{
		...
		$this->parameters += [
			'appDir' => 'C:\xampp\htdocs\menu\app',
			'wwwDir' => 'C:\xampp\htdocs\menu\www',
			'debugMode' => true,
			'productionMode' => false,
			'consoleMode' => false,
			'tempDir' => 'C:\xampp\htdocs\menu\app/../temp',
		];
	}


	public function createServiceApplication__1(): App\Presenters\AddAlergenpagePresenter
	{
		$service = new App\Presenters\AddAlergenpagePresenter($this->getService('1'));
	...
	public function createServiceApplication__10(): App\Presenters\LoginpagePresenter
	{
		$service = new App\Presenters\LoginpagePresenter;
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__11(): App\Presenters\RegistracepagePresenter
	{
		$service = new App\Presenters\RegistracepagePresenter($this->getService('1'), $this->getService('2'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__2(): App\Presenters\AddJidlopagePresenter
	{
		$service = new App\Presenters\AddJidlopagePresenter($this->getService('1'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__3(): App\Presenters\AlergenypagePresenter
	{
		$service = new App\Presenters\AlergenypagePresenter($this->getService('1'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__4(): App\Presenters\ConfirmpagePresenter
	{
		$service = new App\Presenters\ConfirmpagePresenter($this->getService('http.request'), $this->getService('1'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__5(): App\Presenters\DetailApagePresenter
	{
		$service = new App\Presenters\DetailApagePresenter($this->getService('1'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__6(): App\Presenters\DetailpagePresenter
	{
		$service = new App\Presenters\DetailpagePresenter($this->getService('1'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	{
		$service = new App\Presenters\HomepagePresenter($this->getService('1'));
		$service->injectPrimary(
			$this,
			$this->getService('application.presenterFactory'),
			$this->getService('routing.router'),
	...
	public function createServiceApplication__presenterFactory(): Nette\Application\IPresenterFactory
	{
		$service = new Nette\Application\PresenterFactory(new Nette\Bridges\ApplicationDI\PresenterFactoryCallback(
			$this,
			5,
			'C:\xampp\htdocs\menu\app/../temp/cache/Nette%5CBridges%5CApplicationDI%5CApplicationExtension'
		));
	...
	public function createServiceAuthenticator(): app\Model\autentikator
	{
		$service = new app\Model\autentikator($this->getService('1'));
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\SQLiteJournal('C:\xampp\htdocs\menu\app/../temp/cache/journal.s3db');
		return $service;
	}
	...
	{
		$service = new Nette\Caching\Storages\FileStorage('C:\xampp\htdocs\menu\app/../temp/cache', $this->getService('cache.journal'));
		return $service;
	}
	...
	{
		$service = new Nette\Database\Connection('mysql:host=127.0.0.1;dbname=menu', 'root', null, null);
	...
	public function createServiceLatte__latteFactory(): Nette\Bridges\ApplicationLatte\ILatteFactory
	{
		return new class ($this) implements Nette\Bridges\ApplicationLatte\ILatteFactory {
			...
			public function __construct(Container_85c4e39194 $container)
			{
			...
			public function create(): Latte\Engine
			{
				...
				$service->setTempDirectory('C:\xampp\htdocs\menu\app/../temp/cache/latte');
	...
	{
		$service = new Nextras\MailPanel\FileMailer('C:\xampp\htdocs\menu\app/../temp/mail-panel-mails');
		return $service;
	}
	...
	public function createService1(): app\Model\connDatabase
	{
		$service = new app\Model\connDatabase($this->getService('database.default.context'));
		return $service;
	}


	public function createService2(): app\Model\mailService
	{
		$service = new app\Model\mailService;
		return $service;
	}
	...
	public function initialize()
	{
		...
		$this->getService('tracy.bar')->addPanel(new Nextras\MailPanel\MailPanel(
			'C:\xampp\htdocs\menu\app/../temp/mail-panel-latte',
			$this->getService('http.request'),
